function snrgCreditBadge(value) {
...
function addCreditStatusFilter(listview, label, status) {
  listview.page.add_inner_button(label, () => {
    listview.filter_area.add([
      ["Quotation", "custom_snrg_credit_check_status", "=", status],
    ]);
  });
}
...
frappe.listview_settings["Quotation"] = {
  ...
  onload(listview) {
    addCreditStatusFilter(listview, __("Credit OK"), "Credit OK");
    addCreditStatusFilter(listview, __("Credit Hold"), "Credit Hold");
  },

  formatters: {
    custom_snrg_credit_check_status(value) {
      return snrgCreditBadge(value);
    },
  },
};
