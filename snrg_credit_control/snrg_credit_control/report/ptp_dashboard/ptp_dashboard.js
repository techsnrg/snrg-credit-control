frappe.query_reports["PTP Dashboard"] = {
    filters: [
        ...
        },
        {
            ...
            get_data(txt) {
                const options = ["Pending", "Partially Cleared", "Cleared", "Broken", "Superseded"];
                return options
        ...
        {
            fieldname: "requested_to_employee",
    ...
    formatter(value, row, column, data, default_formatter) {
        ...
        if (column.fieldname === "status") {
            ...
            return `<span style="color:${colors[data.status] || "gray"};font-weight:600;">${formatted}</span>`;
        }
        ...
        if (column.fieldname === "bucket") {
            ...
            return `<span style="color:${colors[data.bucket] || "#6b7280"};font-weight:600;">${formatted}</span>`;
        }
